                ...
                <div id="portfolio" class="portfolio-full-description">
                    ...
                    <div class="portfolios hentry work group">
                        <div class="work-thumbnail">
                            <a class="thumb"><img src="{{ asset(env('THEME')) }}/images/projects/{{ $portfolio->img_max }}" alt="0081" title="0081" /></a>
                        </div>
                    ...
                    <div class="portfolio-full-description-related-projects">
                        ...
                        @foreach($portfolios as $portfolio)
                            ...
                            <div class="related_project">
                                <a class="related_proj related_img" href="{{ route('portfolios.show', ['alias' => $portfolio->alias]) }}" title="Love"><img src="{{ asset(env('THEME')) }}/images/projects/{{ $portfolio->img_min }}" alt="0061" title="0061" /></a>
