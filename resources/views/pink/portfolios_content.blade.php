            ...
            @foreach($portfolios as $portfolio)
                ...
                <div class="hentry work group">
                    <div class="work-thumbnail">
                        <div class="nozoom">
                            <img src="{{ asset(env('THEME')) }}/images/projects/{{ $portfolio->img_max }}" alt="0061" title="0061" />
                            <div class="overlay">
                                <a class="overlay_img" href="{{ asset(env('THEME')) }}/images/projects/{{ $portfolio->img_max }}" rel="lightbox" title="{{ $portfolio->title }}"></a>
                                <a class="overlay_project" href="{{ route('portfolios.show', ['alias' => $portfolio->alias]) }}"></a>
                                <span class="{{ $portfolio->title }}">Love</span>
                            </div>
                        </div>
                    </div>
                    <div class="work-description">
                        ...
                        <div class="work-skillsdate">
                            ...
                            @if($portfolio->created_at)
                                <p class="workdate"><span class="label">Years:</span>{{ $portfolio->created_at->format('Y') }}</p>
                            @endif
                        </div>
